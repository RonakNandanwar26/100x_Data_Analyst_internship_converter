...
Most_Popular_Integrations.columns = ['Top Integrations','count of top Integrations']
Most_Popular_Integrations['Type of Integrations'] = 'Most Popular Integrations'

integrals_max_df = pd.concat([integrals_max_df,Most_Popular_Integrations],axis=1)

df = integrals_max_df['Type of Integrations']
integrals_max_df.drop('Type of Integrations',axis=1,inplace=True)
integrals_max_df.insert(3,'Type of Integrations',df)


integrals_max_df.to_sql(name='integrals_max',con=engine,index=False,if_exists='replace')