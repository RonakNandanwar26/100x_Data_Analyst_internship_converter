...
final_df.to_sql(name='cleaned_data',con=engine,index=False,if_exists='replace')
sn2an_df.to_sql(name='software_name_to_actual_name',con=engine,index=False,if_exists='replace')
sn2an_notfound_df.to_sql(name='actual_name_not_found',con=engine,index=False,if_exists='replace')
