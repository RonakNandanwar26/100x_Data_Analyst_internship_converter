...
try:
    sheet.add_worksheet(rows=500,cols=200,title='L1-L2 Overall Data')
except:
    L1_L2_overall_sheet = client.open(google_spreadsheet).worksheet('L1-L2 Overall Data')

L1_L2_overall_sheet = client.open(google_spreadsheet).worksheet('L1-L2 Overall Data')

set_with_dataframe(L1_L2_overall_sheet,L1_L2_overall_df)