...
try:
    sheet.add_worksheet(rows=1000,cols=50,title='Functional Analysis')
except:
    Functional_Analysis_sheet = client.open(google_spreadsheet).worksheet('Functional Analysis')
...
set_with_dataframe(Functional_Analysis_sheet,L1_graph_df)
...
try:
    ...
    sheet1 = client.open(google_spreadsheet).worksheet(top_4_soft[0])
...
set_with_dataframe(sheet1,first_soft_final_df)
...
try:
    ...
    sheet2 = client.open(google_spreadsheet).worksheet(top_4_soft[1])
...
set_with_dataframe(sheet3,third_soft_final_df)
...
try:
    ...
    sheet4 = client.open(google_spreadsheet).worksheet(top_4_soft[3])
...
set_with_dataframe(sheet4,fourth_soft_final_df)
